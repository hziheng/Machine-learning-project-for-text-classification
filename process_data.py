...
class Data_Excuter:
    def __init__(self, data_path, split_size, is_sample=False, split=True) -> None:
    ...
    def train_test_split(self):
        """
        这里的划分是按照每个标签的数量进行划分，确保训练集和验证集中的标签种类一致，不会出现训练集里有，而测试集里没有
        """
...
if __name__ == '__main__':
    ...
    data_ex = Data_Excuter(data_path, 0.3, is_sample=True)