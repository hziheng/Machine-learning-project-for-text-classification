...
class BertPreTrainedModel(nn.Module):
    ...
    def from_scratch(cls, pretrained_model_name_or_path, *inputs, **kwargs):
        ...
        config = nezhaconfig.from_json_file(resolved_config_file)
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *inputs, **kwargs):
        ...
        config = nezhaconfig.from_json_file(config_file)
        logger.info("Model config {}".format(config))
        # Instantiate model.
        model = cls(config, *inputs, **kwargs)
...
class BertForTokenClassification_nezha(BertPreTrainedModel):
    def __init__(self, config, num_labels):
...
class nezha_classify(BertPreTrainedModel):
    def __init__(self, config, num_labels):
        super().__init__(config, )
